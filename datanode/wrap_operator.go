...
func (s *DataNode) OperatePacket(p *repl.Packet, c net.Conn) (err error) {
	...
	case proto.OpNormalWithHoleExtentRepairRead:
		s.handleNormalExtentRepairReadPacket(p, c)
...
func (s *DataNode) handleNormalExtentRepairReadPacket(p *repl.Packet, connect net.Conn) {
...
func writeEmptyPacketOnExtentRepairRead(reply repl.PacketEx, newOffset, currentOffset int64, connect net.Conn) (replySize int64, err error) {
...
// Handle tinyExtentRepairRead packet.
func (s *DataNode) ExtentWithHoleRepairRead(request *repl.Packet, connect net.Conn, getReplyPacket func() repl.PacketEx) {
