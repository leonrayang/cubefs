...
type NewPacketFunc func()(p PacketEx)
type Packet struct {
	proto.Packet
...
type MakeStreamReadResponsePacket func(requestID int64, partitionID uint64, extentID uint64) (p PacketEx)
type MakeExtentRepairReadPacket func(partitionID uint64, extentID uint64, offset, size int) (p PacketEx)

func NewExtentRepairReadPacket(partitionID uint64, extentID uint64, offset, size int) (p PacketEx) {
	pr := new(Packet)
...
func NewTinyExtentRepairReadPacket(partitionID uint64, extentID uint64, offset, size int) (p PacketEx) {
	pr := new(Packet)
	pr.ExtentID = extentID
	pr.PartitionID = partitionID
	pr.Magic = proto.ProtoMagic
...
func NewNormalExtentWithHoleRepairReadPacket(partitionID uint64, extentID uint64, offset, size int) (p PacketEx) {
	pr := new(Packet)
	pr.ExtentID = extentID
	pr.PartitionID = partitionID
	pr.Magic = proto.ProtoMagic
	pr.ExtentOffset = int64(offset)
	pr.Size = uint32(size)
	pr.Opcode = proto.OpNormalWithHoleExtentRepairRead
	pr.ExtentType = proto.TinyExtentType
	pr.ReqID = proto.GenerateRequestID()
...
func NewStreamReadResponsePacket(requestID int64, partitionID uint64, extentID uint64) (p PacketEx) {
	pr := new(Packet)
	pr.ExtentID = extentID
	pr.PartitionID = partitionID
	pr.Magic = proto.ProtoMagic
